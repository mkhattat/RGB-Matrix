...
<p>With your led pannel you can also show pictures. The max size of pictures should be at the max size of pannel. So if you have a 64 width x 32 height pannel, the size of you pictures should be maximum 64x32. The library does not scale the images for you. The library uses a special raw format for the photos. There is a python command line script helps you convert your images at any format to the required raw format. This python script is readbmp.py. In order to use this script you need to install pillow library. </p><div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;python -m pip install Pillow</div></div><!-- fragment --><p> The readbmp script needs two arguments, path to the photo and the name of the new raw file: </p><div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;python readbmp.py photo.jpg myphoto</div></div><!-- fragment --><p> The result is a .h file you can include in your projects and use it to show the photo on the screen: </p><div class="fragment"><div class="line"><span class="preprocessor">#include &quot;myphoto.h&quot;</span></div><div class="line"></div><div class="line"><a class="code" href="class_image.html">Image</a> im(led, myphoto, <a class="code" href="classvector.html">vector</a>(35,0));</div><div class="line">im.draw();</div><div class="line">led.swap_buffer(<span class="keyword">false</span>);</div></div><!-- fragment --><p> in the above example <a class="el" href="classvector.html" title="Implementation of vector class to store x and y. ">vector(35,0)</a> is the location of the library. in this library you should pass location and size of something as a <a class="el" href="classvector.html" title="Implementation of vector class to store x and y. ">vector(x,y)</a>. See also <a class="el" href="vector_8hpp.html">vector.hpp</a></p>
<p><b> Show Animated Images: </b></p>
<p>Not only Images can be shown but Animated Images can also be shown on the led matrix. To use this feature you have to convert a gif animation file to a raw animated image. To do this you can use a python script make_animation.py. This script depends on a pillow library: </p><div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;/// python -m pip install Pillow</div></div><!-- fragment --><p> The make_animation.py script needs two arguments, path to the gif file and the name of the new raw animated file: </p><div class="fragment"><div class="line"><a name="l00001"></a><span class="lineno">    1</span>&#160;python make_animation.py animation.gif myanimation</div></div><!-- fragment --><p> The result is a .h file you can include in your projects and use it to show the animated image on the screen: </p><div class="fragment"><div class="line"><span class="preprocessor">#include &quot;myanimation.h&quot;</span></div><div class="line"></div><div class="line"><a class="code" href="class_animated_image.html">AnimatedImage</a> aIm(led, animation, <a class="code" href="classvector.html">vector</a>(15, 0));</div><div class="line">aIm.draw();</div></div><!-- fragment --><p> The above code prints animation at location (15, 0). De default is one time from start to end with a update interval 10 milliseconds between each frame. In order to change de update interval and loop option you can declare the function as: </p><div class="fragment"><div class="line">aIm.draw(5, <span class="keyword">true</span>);</div></div><!-- fragment --><p> The above code prints animation with 5 milliseconds update interval between each frame and loop option set to true.</p>
<p><b> Note: </b> The draw() function of <a class="el" href="class_animated_image.html" title="AnimateImage implementation for raw gif files. ">AnimatedImage</a> class doesn't need the buffer_swap operation.</p>
